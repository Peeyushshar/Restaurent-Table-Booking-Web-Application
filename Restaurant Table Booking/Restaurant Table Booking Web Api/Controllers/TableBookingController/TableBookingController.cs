...
*/
                ...
                validData.CreatedBy = "53434386-27b6-44ad-b5df-60f2330a0f76";
       ...
       // [Authorize(Roles = "Admin, Accountant")]
        public async Task<IActionResult> GetAll([FromQuery] QueryRequestDto queryRequest)
        {
            ...
            { FilterOn = queryRequest.filterOn, FilterQuery = queryRequest.filterQuery, SortBy = queryRequest.sortBy, IsAscending = queryRequest.isAscending ?? true
            ,PageNo = queryRequest.pageNo, PageSize = queryRequest.pageSize });
            return Ok(bookings);
        }
       ...
       // [Authorize(Roles = "Admin, Accountant")]
        ...
        [HttpPut]
       // [Authorize(Roles = "Admin, Accountant")]
        public async Task<IActionResult> Update([FromForm]UpdateTableBookingRequestDto updateTableBookingRequest)
        {
